# Blogs API com Node.JS e Express em Arquitetura MSC

## Funcionalidades

Node.js com Express na construção de uma API completamente RESTful.

Conhecimento sobre padrões arquiteturais que adquiri, usando a arquitetura MSC (model-service-controller). Além disso, meus conhecimentos sobre REST, criando uma API completamente RESTful.

Esta seção busca colocar sob nova ótica o jeito com que você programa e o jeito com que você escreve seus testes. Será um projeto de exploração, que vai mais além do que apenas a dificuldade de se construir a API.
...
<img src="https://raw.githubusercontent.com/willianAD/Project-Blogs-API/main/image/Projeto%20Blogs%20API.png">
